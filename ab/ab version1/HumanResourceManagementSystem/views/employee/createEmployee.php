...
<div class="container body">
                                ...
                                <form class="form-horizontal form-label-left" novalidate>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="firstName" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="firstName" placeholder="first name ..." required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="lastName" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="lastName" placeholder="last name ..." required="required" type="text">
                                        </div>
                                    </div>
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="url" id="website" name="website" class="form-control" value="http://www.oepesd-tabara.org" required>
    </div>
</div>
