...
<body stye="background-color: white;">
	<div class="main-wthree" stye="bacckground-color: white;">
		<div class="container" stye="bacckground-color: white;">
			
		<div class="sin-w3-agile" stye="bacckground-color: white;">
		    <center>
			<h6><img src="logo.png" alt="Company Logo" style="height:70px; width: fit-content;"/></h6>
			
			<h3 class="text-center text-white">Employees Management System</h3>
			</center>
			<form action="controller/login.php" method="post">
				...
				<div class="clearfix"></div>
					...
					<div class="footer">
						<p>OEPESD-TABARA. All Rights Reserved &copy; <?= date("Y") ?> </p>
						<!--<P>Powered by A&B DIGITAL ARTS LTD</P>-->
					</div>
		</div>
		</div>
	</div>
